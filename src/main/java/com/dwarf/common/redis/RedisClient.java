package com.dwarf.common.redis;
...
public class RedisClient {
	...
	static {
		InputStream in = RedisClient.class.getClassLoader().getResourceAsStream("server.properties");
		try {
			prop.load(in);
	...
	private RedisClient() {
		pool = new JedisPool(prop.getProperty("redis_host"), Integer.parseInt(prop.getProperty("redis_port")));
	}
